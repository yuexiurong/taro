  ...
  render(){
    ...
    return(
      <View className="addcut">
        <Image onClick={this.CutFood.bind(this)} className={"opeate_img "+hideClass} src={require('../../assets/img/minus-bold.png')}></Image>
        <Text className={"food_num "+hideClass}>{Num}</Text>
        <Image onClick={this.AddFood.bind(this)} className="opeate_img" src={require('../../assets/img/add-bold.png')}></Image>
      </View>
    )
  }
}
